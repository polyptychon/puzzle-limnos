...
const data = {
  "el": {
    ...
    "laikes": {
      "title": "Λαϊκές",
      "subtitle": "κατοικίες",
      "description": "Στις παραδοσιακές λαϊκές κατοικίες βλέπει κανείς χαμηλά κτίσματα με ένα ή και δύο ορόφους. Τα ισόγεια, με σμυρνέικο στυλ, περιλαμβάνουν κεντρικό διάδρομο με την κουζίνα στο βάθος και δύο ή τέσσερα δωμάτια δεξιά κι αριστερά του διαδρόμου (Τύπος Α). Στα διώροφα, τα «δίπατα», το ισόγειο είναι χαμηλό σε ύψος. Είναι το \"κατώι\" που λειτουργεί ως στάβλος ή αποθήκη. Στο ανώι οδηγεί εσωτερική ή εξωτερική σκάλα. Εκεί βρίσκονται τα υπνοδωμάτια, η κρεβατοκάμαρα για το ζευγάρι κι ένα πιο μεγάλο δωμάτιο, η «μεγάλ’ κάμαρ’» το οποίο χρησιμοποιούσαν για να υποδέχονται τους καλεσμένους, αλλά και για τον ύπνο των παιδιών. (Τύπος Β) Η ανάγκη διαχωρισμού των χώρων και των λειτουργιών του σπιτιού οδήγησαν στη δημιουργία της χαρακτηριστικής κατοικίας με \"αξάτα\", δηλαδή τη μικρή ή μεγαλύτερη υπερυψωμένη βεράντα του σπιτιού, στην οποία οδηγεί εξωτερική πέτρινη σκάλα. Ο όροφος φιλοξενεί και πάλι τα δωμάτια, ενώ στο κατώι βρίσκεται ο στάβλος, και οι αποθήκες ή το μαγειριό, με διαχωρισμένες πλέον εισόδους. (Τύπος Γ) Τα περισσότερα σπίτια είχαν μια μικρή αυλή ή κήπο, με εξωτερικό φούρνο κι ένα μικρό βοηθητικό «παρασπίτι» για την αποθήκευση προϊόντων και τις βοηθητικές εργασίες.",
      "images": imagesLaikes,
